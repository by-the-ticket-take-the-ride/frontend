  ...
  if (props.type === 'register') {
    linkText = (
      <p className="auth-bottom__to-login text-reset">
        Уже зарегистрированы? <span onClick={props.handleClickLogin} className="auth-bottom__to-login-link text-reset link-hover">
          Войти в профиль
        </span>
      </p>
    );
    ...
    linkText = (
      <p onClick={props.handleClickRegister} className="auth-bottom__to-login auth-bottom__text_align text-reset">
        <span onClick={props.handleClickRegister} className="auth-bottom__to-login-link text-reset link-hover">
          Регистрация
        </span>
      </p>
    );
